...
def test_completion_extracts_partial_config_from_kwargs() -> None:
    ...
    with patch("any_llm.main.ProviderFactory") as mock_factory:
        ...
        mock_factory.create_provider.assert_called_once_with("mistral", ApiConfig(api_key="test_key"))
...
def test_completion_no_config_extraction() -> None:
    ...
    with patch("any_llm.main.ProviderFactory") as mock_factory:
        ...
        mock_factory.create_provider.assert_called_once_with("mistral", ApiConfig())
...
def test_completion_extracts_api_base_only() -> None:
    ...
    with patch("any_llm.main.ProviderFactory") as mock_factory:
        ...
        mock_factory.create_provider.assert_called_once_with(
            "ollama", ApiConfig(api_base="https://custom-endpoint.com")
        )
